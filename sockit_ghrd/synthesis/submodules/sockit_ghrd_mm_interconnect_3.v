// sockit_ghrd_mm_interconnect_3.v
...
`timescale 1 ps / 1 ps
module sockit_ghrd_mm_interconnect_3 (
	...
	sockit_ghrd_mm_interconnect_3_router router (
	...
	sockit_ghrd_mm_interconnect_3_router_001 router_001 (
	...
	sockit_ghrd_mm_interconnect_3_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                           //       clk.clk
		.reset              (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sockit_ghrd_mm_interconnect_3_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                                      //       clk.clk
		.reset               (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sockit_ghrd_mm_interconnect_3_cmd_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                                      //       clk.clk
		.reset              (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sockit_ghrd_mm_interconnect_3_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                           //       clk.clk
		.reset               (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
