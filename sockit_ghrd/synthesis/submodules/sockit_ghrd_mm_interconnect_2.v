// sockit_ghrd_mm_interconnect_2.v
...
`timescale 1 ps / 1 ps
module sockit_ghrd_mm_interconnect_2 (
	...
	sockit_ghrd_mm_interconnect_2_router router (
	...
	sockit_ghrd_mm_interconnect_2_router_001 router_001 (
	...
	sockit_ghrd_mm_interconnect_2_router_001 router_002 (
	...
	sockit_ghrd_mm_interconnect_2_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                       //       clk.clk
		.reset              (hps_only_master_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sockit_ghrd_mm_interconnect_2_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sockit_ghrd_mm_interconnect_2_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sockit_ghrd_mm_interconnect_2_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sockit_ghrd_mm_interconnect_2_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sockit_ghrd_mm_interconnect_2_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_only_master_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
